...
- Rationale: Preserves correctness for user progress and FSRS v6 scheduling when DynamoDB is transiently unavailable.
...
- Rationale: Prevents conflicting schedule truth and simplifies FSRS v6 correctness.
