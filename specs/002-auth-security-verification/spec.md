...
- **Algorithm Fidelity**: No impact on FSRS v6 scheduling behavior, card-state transitions, or account-level daily learning limits.
...
- **FR-014**: System MUST preserve existing FSRS v6 scheduling fidelity, card-state transitions, and account-level daily learning limits without modification.
